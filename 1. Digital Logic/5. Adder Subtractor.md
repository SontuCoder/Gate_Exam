...
> - For implement a half-adder, we need to use 5 NOR or 5 NAND gates.
> - Sum = A'B + AB'
> - Carry = AB

# **Full Adder/ three bits adder:**
> - For implement a full-adder, we need to use 9 NOR or 9 NAND gates.
> - Sum = A⊕B⊕C
> - Carry = A'BC + AB'C + ABC' + ABC = AB + BC + AC

---

# **Half Subtructor/ two bits Subtructor:**
> - For implement a half-subtructor, we need to use 5 NOR or 5 NAND gates.
> - Diff = A'B + AB'
> - Borrow = A'B

# **Full Subtructor/ three bits Subtructor:**
> - For implement a full-subtructor, we need to use 9 NOR or 9 NAND gates.
> - Diff = A⊕B⊕C
> - Borrow = A'B'C + A'BC' + A'BC + ABC = A'B + BC + A'C
